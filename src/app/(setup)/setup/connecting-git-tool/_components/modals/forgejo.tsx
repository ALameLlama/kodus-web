...
/**
 * Modal for setting up Forgejo/Gitea integration during the setup flow.
 *
 * Requires:
 * 1. Host URL of the Forgejo instance
        ...
        <Dialog open onOpenChange={() => magicModal.hide()}>
            <DialogContent>
                <form onSubmit={form.handleSubmit(submit)}>
                    <DialogHeader>
                        <DialogTitle>
                            Forgejo / Gitea Personal Access Token
                        </DialogTitle>
                                ...
                                <Controller
                                    ...
                                    render={({ field, fieldState }) => (
                                        <FormControl.Root>
                                            ...
                                            <FormControl.Helper>
                                                The URL of your Forgejo or Gitea
                                                instance
                                            </FormControl.Helper>
